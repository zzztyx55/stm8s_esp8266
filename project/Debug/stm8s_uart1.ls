 ...
 392                     ; 83 void UART1_Init(uint32_t BaudRate, UART1_WordLength_TypeDef WordLength, 
 392                     ; 84                 UART1_StopBits_TypeDef StopBits, UART1_Parity_TypeDef Parity, 
 392                     ; 85                 UART1_SyncMode_TypeDef SyncMode, UART1_Mode_TypeDef Mode)
 392                     ; 86 {
 393                     	switch	.text
 394  002b               _UART1_Init:
 396  002b 520c          	subw	sp,#12
 397       0000000c      OFST:	set	12
 400                     ; 87     uint32_t BaudRate_Mantissa = 0, BaudRate_Mantissa100 = 0;
 404                     ; 90     assert_param(IS_UART1_BAUDRATE_OK(BaudRate));
 406                     ; 91     assert_param(IS_UART1_WORDLENGTH_OK(WordLength));
 408                     ; 92     assert_param(IS_UART1_STOPBITS_OK(StopBits));
 410                     ; 93     assert_param(IS_UART1_PARITY_OK(Parity));
 412                     ; 94     assert_param(IS_UART1_MODE_OK((uint8_t)Mode));
 414                     ; 95     assert_param(IS_UART1_SYNCMODE_OK((uint8_t)SyncMode));
 416                     ; 98     UART1->CR1 &= (uint8_t)(~UART1_CR1_M);  
 418  002d 72195234      	bres	21044,#4
 419                     ; 101     UART1->CR1 |= (uint8_t)WordLength;
 421  0031 c65234        	ld	a,21044
 422  0034 1a13          	or	a,(OFST+7,sp)
 423  0036 c75234        	ld	21044,a
 424                     ; 104     UART1->CR3 &= (uint8_t)(~UART1_CR3_STOP);  
 426  0039 c65236        	ld	a,21046
 427  003c a4cf          	and	a,#207
 428  003e c75236        	ld	21046,a
 429                     ; 106     UART1->CR3 |= (uint8_t)StopBits;  
 431  0041 c65236        	ld	a,21046
 432  0044 1a14          	or	a,(OFST+8,sp)
 433  0046 c75236        	ld	21046,a
 434                     ; 109     UART1->CR1 &= (uint8_t)(~(UART1_CR1_PCEN | UART1_CR1_PS  ));  
 436  0049 c65234        	ld	a,21044
 437  004c a4f9          	and	a,#249
 438  004e c75234        	ld	21044,a
 439                     ; 111     UART1->CR1 |= (uint8_t)Parity;  
 441  0051 c65234        	ld	a,21044
 442  0054 1a15          	or	a,(OFST+9,sp)
 443  0056 c75234        	ld	21044,a
 444                     ; 114     UART1->BRR1 &= (uint8_t)(~UART1_BRR1_DIVM);  
 446  0059 725f5232      	clr	21042
 447                     ; 116     UART1->BRR2 &= (uint8_t)(~UART1_BRR2_DIVM);  
 449  005d c65233        	ld	a,21043
 450  0060 a40f          	and	a,#15
 451  0062 c75233        	ld	21043,a
 452                     ; 118     UART1->BRR2 &= (uint8_t)(~UART1_BRR2_DIVF);  
 454  0065 c65233        	ld	a,21043
 455  0068 a4f0          	and	a,#240
 456  006a c75233        	ld	21043,a
 457                     ; 121     BaudRate_Mantissa    = ((uint32_t)CLK_GetClockFreq() / (BaudRate << 4));
 ...
 480                     ; 122     BaudRate_Mantissa100 = (((uint32_t)CLK_GetClockFreq() * 100) / (BaudRate << 4));
 ...
 506                     ; 124     UART1->BRR2 |= (uint8_t)((uint8_t)(((BaudRate_Mantissa100 - (BaudRate_Mantissa * 100)) << 4) / 100) & (uint8_t)0x0F); 
 ...
 537                     ; 126     UART1->BRR2 |= (uint8_t)((BaudRate_Mantissa >> 4) & (uint8_t)0xF0); 
 ...
 628  016a 81            	ret
 683                     ; 177 void UART1_Cmd(FunctionalState NewState)
 683                     ; 178 {
 684                     	switch	.text
 685  016b               _UART1_Cmd:
 689                     ; 179     if (NewState != DISABLE)
 691  016b 4d            	tnz	a
 692  016c 2706          	jreq	L532
 693                     ; 182         UART1->CR1 &= (uint8_t)(~UART1_CR1_UARTD); 
 ...
 703                     ; 189 }
 706  0178 81            	ret
 831                     ; 205 void UART1_ITConfig(UART1_IT_TypeDef UART1_IT, FunctionalState NewState)
 831                     ; 206 {
 832                     	switch	.text
 ...
 840                     ; 207     uint8_t uartreg = 0, itpos = 0x00;
 844                     ; 210     assert_param(IS_UART1_CONFIG_IT_OK(UART1_IT));
 846                     ; 211     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 848                     ; 214     uartreg = (uint8_t)((uint16_t)UART1_IT >> 0x08);
 850  017b 9e            	ld	a,xh
 851  017c 6b01          	ld	(OFST-1,sp),a
 852                     ; 216     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART1_IT & (uint8_t)0x0F));
 854  017e 9f            	ld	a,xl
...
1634                     ; 458   return (uint16_t)( (((uint16_t) UART1->DR) | temp ) & ((uint16_t)0x01FF));
...
1652  028a 81            	ret
1686                     ; 466 void UART1_SendData8(uint8_t Data)
1686                     ; 467 {
1687                     	switch	.text
1688  028b               _UART1_SendData8:
1692                     ; 469     UART1->DR = Data;
1694  028b c75231        	ld	21041,a
1695                     ; 470 }
1698  028e 81            	ret
1732                     ; 478 void UART1_SendData9(uint16_t Data)
1732                     ; 479 {
1733                     	switch	.text
1734  028f               _UART1_SendData9:
1736  028f 89            	pushw	x
1737       00000000      OFST:	set	0
1740                     ; 481     UART1->CR1 &= ((uint8_t)~UART1_CR1_T8);
1742  0290 721d5234      	bres	21044,#6
1743                     ; 483     UART1->CR1 |= (uint8_t)(((uint8_t)(Data >> 2)) & UART1_CR1_T8);
1745  0294 54            	srlw	x
1746  0295 54            	srlw	x
...
1751                     ; 485     UART1->DR   = (uint8_t)(Data);
1753  029f 7b02          	ld	a,(OFST+2,sp)
1754  02a1 c75231        	ld	21041,a
1755                     ; 486 }
1758  02a4 85            	popw	x
1759  02a5 81            	ret
1782                     ; 493 void UART1_SendBreak(void)
1782                     ; 494 {
1783                     	switch	.text
1784  02a6               _UART1_SendBreak:
1788                     ; 495     UART1->CR2 |= UART1_CR2_SBK;
1790  02a6 72105235      	bset	21045,#0
1791                     ; 496 }
1794  02aa 81            	ret
1828                     ; 503 void UART1_SetAddress(uint8_t UART1_Address)
1828                     ; 504 {
1829                     	switch	.text
1830  02ab               _UART1_SetAddress:
1832  02ab 88            	push	a
1833       00000000      OFST:	set	0
1836                     ; 506     assert_param(IS_UART1_ADDRESS_OK(UART1_Address));
1838                     ; 509     UART1->CR4 &= ((uint8_t)~UART1_CR4_ADD);
1840  02ac c65237        	ld	a,21047
1841  02af a4f0          	and	a,#240
1842  02b1 c75237        	ld	21047,a
1843                     ; 511     UART1->CR4 |= UART1_Address;
...
1851  02bc 84            	pop	a
1852  02bd 81            	ret
1886                     ; 520 void UART1_SetGuardTime(uint8_t UART1_GuardTime)
1886                     ; 521 {
1887                     	switch	.text
1888  02be               _UART1_SetGuardTime:
1892                     ; 523     UART1->GTR = UART1_GuardTime;
1894  02be c75239        	ld	21049,a
1895                     ; 524 }
1898  02c1 81            	ret
1932                     ; 548 void UART1_SetPrescaler(uint8_t UART1_Prescaler)
1932                     ; 549 {
1933                     	switch	.text
1934  02c2               _UART1_SetPrescaler:
1938                     ; 551     UART1->PSCR = UART1_Prescaler;
1940  02c2 c7523a        	ld	21050,a
1941                     ; 552 }
1944  02c5 81            	ret
2087                     ; 560 FlagStatus UART1_GetFlagStatus(UART1_Flag_TypeDef UART1_FLAG)
2087                     ; 561 {
2088                     	switch	.text
...
2096                     ; 562     FlagStatus status = RESET;
2098                     ; 565     assert_param(IS_UART1_FLAG_OK(UART1_FLAG));
2100                     ; 569     if (UART1_FLAG == UART1_FLAG_LBDF)
2102  02c8 a30210        	cpw	x,#528
2103  02cb 2610          	jrne	L7501
2104                     ; 571         if ((UART1->CR4 & (uint8_t)UART1_FLAG) != (uint8_t)0x00)
...
2137  02f1               L1701:
2138                     ; 592             status = RESET;
2140  02f1 0f01          	clr	(OFST+0,sp)
2141  02f3 200f          	jra	L5601
2142  02f5               L7601:
2143                     ; 597         if ((UART1->SR & (uint8_t)UART1_FLAG) != (uint8_t)0x00)
...
2154  0302               L7701:
2155                     ; 605             status = RESET;
2157  0302 0f01          	clr	(OFST+0,sp)
2158  0304               L5601:
2159                     ; 609     return status;
2161  0304 7b01          	ld	a,(OFST+0,sp)
2164  0306 5b03          	addw	sp,#3
2165  0308 81            	ret
2200                     ; 639 void UART1_ClearFlag(UART1_Flag_TypeDef UART1_FLAG)
2200                     ; 640 {
2201                     	switch	.text
2202  0309               _UART1_ClearFlag:
2206                     ; 641     assert_param(IS_UART1_CLEAR_FLAG_OK(UART1_FLAG));
2208                     ; 644     if (UART1_FLAG == UART1_FLAG_RXNE)
2210  0309 a30020        	cpw	x,#32
2211  030c 2606          	jrne	L1211
2212                     ; 646         UART1->SR = (uint8_t)~(UART1_SR_RXNE);
2214  030e 35df5230      	mov	21040,#223
2216  0312 2004          	jra	L3211
2217  0314               L1211:
2218                     ; 651         UART1->CR4 &= (uint8_t)~(UART1_CR4_LBDF);
2220  0314 72195237      	bres	21047,#4
2221  0318               L3211:
2222                     ; 653 }
2225  0318 81            	ret
2307                     ; 668 ITStatus UART1_GetITStatus(UART1_IT_TypeDef UART1_IT)
2307                     ; 669 {
2308                     	switch	.text
...
2316                     ; 670     ITStatus pendingbitstatus = RESET;
2318                     ; 671     uint8_t itpos = 0;
2320                     ; 672     uint8_t itmask1 = 0;
2322                     ; 673     uint8_t itmask2 = 0;
2324                     ; 674     uint8_t enablestatus = 0;
2326                     ; 677     assert_param(IS_UART1_GET_IT_OK(UART1_IT));
2328                     ; 680     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART1_IT & (uint8_t)0x0F));
...
2343                     ; 682     itmask1 = (uint8_t)((uint8_t)UART1_IT >> (uint8_t)4);
2345  032b 7b04          	ld	a,(OFST+2,sp)
2346  032d 4e            	swap	a
2347  032e a40f          	and	a,#15
2348  0330 6b02          	ld	(OFST+0,sp),a
2349                     ; 684     itmask2 = (uint8_t)((uint8_t)1 << itmask1);
...
2436                     ; 730             pendingbitstatus = SET;
2438  0399 a601          	ld	a,#1
2439  039b 6b02          	ld	(OFST+0,sp),a
2441  039d 2002          	jra	L5711
2442  039f               L7021:
2443                     ; 735             pendingbitstatus = RESET;
2445  039f 0f02          	clr	(OFST+0,sp)
2446  03a1               L5711:
2447                     ; 740     return  pendingbitstatus;
2449  03a1 7b02          	ld	a,(OFST+0,sp)
2452  03a3 5b04          	addw	sp,#4
2453  03a5 81            	ret
2489                     ; 768 void UART1_ClearITPendingBit(UART1_IT_TypeDef UART1_IT)
2489                     ; 769 {
2490                     	switch	.text
2491  03a6               _UART1_ClearITPendingBit:
2495                     ; 770     assert_param(IS_UART1_CLEAR_IT_OK(UART1_IT));
2497                     ; 773     if (UART1_IT == UART1_IT_RXNE)
2499  03a6 a30255        	cpw	x,#597
2500  03a9 2606          	jrne	L1321
2501                     ; 775         UART1->SR = (uint8_t)~(UART1_SR_RXNE);
2503  03ab 35df5230      	mov	21040,#223
2505  03af 2004          	jra	L3321
2506  03b1               L1321:
2507                     ; 780         UART1->CR4 &= (uint8_t)~(UART1_CR4_LBDF);
